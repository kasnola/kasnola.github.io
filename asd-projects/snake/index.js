...
// rate at which the game runs, in ms. default 100
var gameRate = 100;
...
function init() {
  ...
  updateInterval = setInterval(update, gameRate);
}
...
function checkForNewDirection(event) {
  ...
  */
  ...
  // console.log(`column ${snake.head.column}`);
  // console.log(`row ${snake.head.row}`);
  // console.log(`tailcolumn ${snake.tail.column}`);
  // console.log(`tailrow ${snake.tail.row}`);
